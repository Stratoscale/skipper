...
class TestBuilder(TestCase):
    ...
    def test_build_with_use_cache(self):
        ...
        expected_cmds = [
            ...
            mock.call(["push", options.image.cache_fqdn]),
        ]
    ...
    def test_build_with_options_from_context(self):
        ...
        options = BuildOptions.from_context_obj(ctx_obj)
        expected_cmds = [
            mock.call(["pull", "test:cache"]),
            mock.call(
                [
                    "build",
                    "--network=host",
            ...
            mock.call(["tag", "test", "test:cache"]),
            mock.call(["push", "test:cache"]),
        ]
